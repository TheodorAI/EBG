...
def gpt_output(prompt):
    messages=[
    {"role": "system", "content": "Play as a careful thinker to follow the instructions"},
...
def write_to_file(error_code, dict1, dict2, dict3, dict4, dict5, dict6, filename='result_gpt4.txt'):
...
if __name__ == '__main__':
    label_list, question_list = read_csv('evaluation.csv')
