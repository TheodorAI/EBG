...
def write_to_file(error_code, dict1, dict2, dict3, dict4, dict5, dict6, filename='./result/result_llama_avgpadding.txt'):
...
def main():
    ...
    label_list, question_list = read_csv('./data/evaluation_test.csv')
    ...
    for i in range(len(question_list)):
        question_list[i] = create_COT(question_list[i])
